...
export const reservedRoutes = ['chats', 'search', 'profile', 'settings', 'login', 'sso-callback', 'api', 'admin', 'termos-de-uso', 'politica-de-privacidade', 'institucional', 'onboarding', 'ajuda', 'founders'];
