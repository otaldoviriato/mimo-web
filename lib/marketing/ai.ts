    ...
    async analyzeScoutProfile(
        ...
        return this.requestJson<ScoutProfileAnalysis>(
            ...
            [
                ...
                'A compatibilidade depende de identificar indícios de que o perfil produz ou vende conteúdo adulto, exclusivo ou privado.',
                'Não faça uma média geral do perfil se ele contiver profissões tradicionais descritas (como Nutri, maquiadora, laces, etc.). Você deve buscar ativamente e com alta sensibilidade qualquer sinal sutil, subjetivo, metafórico ou de duplo sentido que aponte para conteúdo exclusivo ou adulto.',
                'Sinais sutis e de duplo sentido essenciais: presença de emojis como pimenta 🌶️ (ex: "Criadora 🌶️"), fogo 🔥, diabinho 😈, cadeado 🔒, ou termos como "Close Friends", "VIP", "conteúdo privado", "VIP privado". Se achar qualquer um desses sinais ou qualquer outra frase sugestiva/duplo sentido, classifique obrigatoriamente como compatibilidade alta (very_promising ou excellent, atingindo score 80-100%), mesmo que o perfil declare uma atuação tradicional em paralelo (como nutrição, moda, estética). O indício de conteúdo adulto/exclusivo prevalece totalmente sobre a profissão tradicional.',
                'Sinais positivos clássicos adicionais: link para Telegram (t.me) e plataformas de conteúdo adulto (ex: Privacy, OnlyFans) ou agregadores apontando para eles, e frases como "Só pra quem sabe aproveitar", "Acesso exclusivo", "Só para maiores". Perfis com link para Telegram e frases de exclusividade devem atingir compatibilidade máxima (excellent).',
                'Ausência de sinais: Classifique obrigatoriamente como incompatible e recomendação reject (score de 20% ou menos) se e somente se o perfil declarar atuação comercial/profissional tradicional (como laces, salão, moda, nutrição) ou não tiver absolutamente nenhuma menção ou indício adulto, sutil ou de duplo sentido na bio ou links.',
                ...
                'A pontuação fina de compatibilidade (por exemplo, diferenciar very_promising de 80% e excellent de 90%+) deve variar principalmente pela localização (perfis do Brasil, com DDD, cidades brasileiras ou em português do Brasil têm prioridade e maior nota) e pela quantidade de seguidores.',
