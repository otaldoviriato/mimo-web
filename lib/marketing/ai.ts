    ...
    async analyzeScoutProfile(
        ...
        return this.requestJson<ScoutProfileAnalysis>(
            ...
            [
                ...
                'A compatibilidade depende principalmente de sinais claros na bio ou no link externo de que a pessoa vende ou tem forte intenção de vender conteúdo adulto, exclusivo ou privado.',
                'Sinais positivos fortíssimos: link para Telegram (t.me), plataformas de conteúdo adulto (ex: Privacy, OnlyFans, Close Friends, etc.) ou agregadores de link apontando para eles, e frases sugestivas como "Só pra quem sabe aproveitar", "Acesso exclusivo", "Só para maiores", "Conteúdo privado". Perfis com Telegram (t.me) e frases de exclusividade como "Só pra quem sabe aproveitar" devem pontuar muito alto, alcançando excellent ou very_promising.',
                'Sinais negativos críticos: se a bio indicar claramente que a pessoa trabalha com serviços ou comércios tradicionais sem relação com conteúdo adulto (ex: Laces, apliques, auto maquiagem, designer de cílios, salão de beleza, loja de roupas físicas, confeitaria, nutrição, etc.), classifique obrigatoriamente como incompatible e recomendação reject (score de 20 ou menos), a menos que ela venda explicitamente conteúdo adulto em paralelo.',
                'Sem ao menos um indício de conteúdo adulto ou exclusivo na bio ou no link externo, use incompatible e recomendação reject, mesmo que o perfil seja ativo ou tenha muitos seguidores.',
