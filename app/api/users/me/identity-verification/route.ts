                ...
                await resend.emails.send({
                    ...
                    html: `
                        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
                            ...
                            <p style="color: #475569; font-size: 16px;">O usuário <strong>@${updatedUser.username}</strong> acabou de enviar os documentos de identidade e selfie para análise de maioridade.</p>
