...
function useAnimatedNumber(target: number, isInitialLoading: boolean, duration: number = 600) {
    ...
    useEffect(() => {
        ...
        const animate = (now: number) => {
            ...
            const val = Math.round(startRef.current + (target - startRef.current) * easeProgress);
    ...
    }, [target, isInitialLoading, duration]);
...
export default function WalletPage() {
    ...
    const animatedBalance = useAnimatedNumber(data.balance || 0, loadingDashboard);
    const animatedTotalWithdrawn = useAnimatedNumber(data.totalWithdrawn || 0, loadingDashboard);
    const animatedAnnualEarnings = useAnimatedNumber(data.annualEarnings || 0, loadingDashboard);
    const animatedProjectedRecurring = useAnimatedNumber(data.projectedMonthlyRecurring || 0, loadingDashboard);
                    ...
                    <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                        ...
                        <div className="flex flex-col items-end">
                            ...
                            <span className="text-base font-black text-emerald-650 leading-tight">
                                {renderValue(animatedTotalWithdrawn)}
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between border-b border-gray-100 pb-2 mb-3">
                        ...
                        <div className="flex flex-col items-end">
                            ...
                            <span className="text-sm font-black text-purple-650 leading-tight">
                                {renderValue(animatedAnnualEarnings)}
                            </span>
                        </div>
                    </div>
