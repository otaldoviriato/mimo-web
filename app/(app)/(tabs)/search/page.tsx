    ...
    const renderCreatorCard = (user: any) => {
        ...
        return (
            ...
            >
                ...
                {user.isAvailable && (
                    <div className="absolute top-2.5 left-2.5 bg-white/95 text-emerald-700 border border-emerald-200/80 text-[10.5px] font-bold px-2.5 py-1 rounded-full shadow-md flex items-center gap-1.5 z-10 backdrop-blur-xs">
